function J = flux (M,t)
  ...
  global X T_1 Tpars n_N_ENR n_N_ER ...
    M_VSd M_VSm M_VRd M_VRm M_VSb M_VRb M_VSp ...
  ...
  %% temperature correction that affects all rates; not yet effectuated
  ...
  r_S = fsolve('findr', findr(0)); % specific growth rate (1/time)
  ...
  r_R = fsolve('findr', min(10,findr(0))); % specific growth rate (1/time)
