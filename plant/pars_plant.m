...
J_L_F = 10; % mol/s, flux of useful photons
X_C = 0.0010;  % M, concentration of carbon dioxide
...
Tpars=[T_A T_L T_H T_AL T_AH]; % temperature parameters
corr_T = tempcorr(T, T_1, Tpars); % correction factor for temperature
...
J_L_K = corr_T * 1;  % mol/s, half-saturation flux of useful photons
...
j_L_Am = corr_T * 50;     % mol/mol.s, max spec uptake of useful photons
j_C_Am = corr_T * 50;     % mol/mol.s, max spec uptake of carbon dioxide
j_O_Am = corr_T * 0.0001; % mol/mol.s, max spec uptake of oxygen
j_NH_Am = corr_T * 0.5;   % mol/mol.s, max spec uptake of ammonia
j_NO_Am = corr_T * 0.5;   % mol/mol.s, max spec uptake of nitrate
...
k_C = corr_T * 1; % 1/s, scaling rate for carbon dioxide
k_O = corr_T * 1; % 1/s, scaling rate for oxygen

%% reserve turnover rates
k_ECS = corr_T * 0.2; % 1/d, shoots' C-reserve turnover rate
k_ENS = corr_T * 0.2; % 1/d, shoots' N-reserve turnover rate
k_ES  = corr_T * 0.2; % 1/d, shoots'   reserve turnover rate
k_ECR = corr_T * 0.2; % 1/d, roots'  C-reserve turnover rate
k_ENR = corr_T * 0.2; % 1/d, roots'  N-reserve turnover rate
k_ER  = corr_T * 0.2; % 1/d, roots'    reserve turnover rate
...
j_ES_MS = corr_T * 0.001; % mol/mol.s, shoots' spec somatic maint costs 
j_ER_MR = corr_T * 0.003; % mol/mol.s, roots' spec somatic maint costs
j_ES_JS = corr_T * 0.001; % mol/mol.s, shoots' spec maturity maint costs 

%% production parameters
%%   these parameters play no dynamic role, but can dominate weights
j_PS_MS = corr_T * 0.01; % mol/mol.s, shoot product formation linked to maintenance
j_PR_MR = corr_T * 0.01; % mol/mol.s, root  product formation linked to maintenance
