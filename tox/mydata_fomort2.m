...
CB0 = 2; % mM, No-Effect-Concentration for B (external, may be zero)
...
dAB = 0; % 1/(h*mM^2), interaction rate for A and B
...
parMC = nmsurv3('fomort2',par,t,c1,c2,N); % back-estimate pars using nead-melder
...
[cor cov sd dev] = psurv3('fomort2',parMC,t,c1,c2,N);
par_txt = ['h0'; 'CA0'; 'CB0'; 'bA'; 'bB'; 'kA'; 'kB'; 'dAB'];
printpar(par_txt,parMC,sd)

%% test if interaction rate dAB differs significantly from zero
parMC0 = [parMC, ones(8,1)]; parMC0(8,:) = [0 0];
parMC0 = nmsurv3('fomort2',parMC0,t,c1,c2,N); % pars with dAB = 0
parMC0 = scsurv3('fomort2',parMC0,t,c1,c2,N); 
dev0 = dev3('fomort2',parMC0,t,c1,c2,N); % get deviance for dAB = 0
