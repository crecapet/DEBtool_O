%% Created at 2002/02/15 by Bas Kooijman; modified 2009/02/20
%% Toxic effects on growth; four modes of action
%%   fegrowth: feeding capacity
...
C = linspace(0,100,50)';
plot(C,as0growth(p_as0(:,1),t,C), 'g', ...
     C,asigrowth(p_asi(:,1),t,C), 'm');
