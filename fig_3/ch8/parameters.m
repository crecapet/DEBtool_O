...
res = [J_XAm; % max feeding rate
       ...
       L_m; % max length
       R_m; % max reprod rate
       eb_min(1); % func response for growth ceasing at birth
       eb_min(2); % func response for maturation ceasing at birth
       ep_min(1); % func response for growth ceasing at puberty
       ep_min(2)]; % func response for maturation ceasing at puberty
