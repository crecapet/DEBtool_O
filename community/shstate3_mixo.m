function shstate3_mixo (j)
  ...
  %% Calls for dstate3_mixo, gstate3_mixo, gstatec3_mixo, finstatec3_mixo,
  %%   gstaten3_mixo, findstaten3_mixo
  %% State vector:
  ...
  x = lsode('dstate3_mixo', istate, [0 100]'); % get first initial estimate
  [xx infox] = gstate3_mixo(x(2,:)'); % get first data-point in L,C,N-diagrams
