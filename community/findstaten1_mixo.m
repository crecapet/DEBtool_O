function X = findstaten1_mixo (X_t)
  %% X = findstaten1_mixo (X_t)
...
global j_L_F Ctot Ntot j_EV_AHVm j_EE_AHEm j_EA_Am j_L_FK ...
  ...
  N=X_t(1); DV=X_t(2); DE=X_t(3); E=X_t(4);
  V = (Ntot - N - n_NV*DV - n_NE*DE - n_NE*E)/n_NV;
  C = Ctot - DV - DE - V - E;
  m_E = E/max(V,1e-8); 
  ...
  X(4) = j_E_AA + j_E_AHV + j_E_AHE + j_E_G + j_E_M + j_E_H; % E, Reserve
