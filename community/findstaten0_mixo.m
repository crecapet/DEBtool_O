function X = findstaten0_mixo (X_t)
  %% X = findstaten0_mixo (X_t)
  ...
  j_VA_AA = j_V_Am * (1 + 1/z_N + 1/z_CH - 1/(z_N + z_CH)) * a * b/ ...
  (a * b + a + b - a * b/ (a + b));
  ...
  %% X(1) = j_C_AA + j_C_AH + j_C_M;     % DIC  
  X(1) = j_N_AA + j_N_AH + j_N_M;        % DIN
  X(2) = j_D_AH + j_D_H;                 % D, Detritus
