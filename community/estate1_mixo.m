function dX = estate1_mixo (X_t, t)
  %% dX = estate1_mixo (X_t, t)
  %% routine called from shtime1, domain mixo
...
global j_L_F Ctot Ntot j_EV_AHVm j_EE_AHEm j_EA_Am j_L_FK ...
  ...
  dX(1) = V*(j_DV_AHV + j_DV_H);          % DV, V-detritus
  dX(2) = V*(j_DE_AHE + j_DE_H);          % DE, E-detritus
  dX(3) = V*(j_V_G + j_V_H);              % V, Structure 
  dX(4) = V*(j_E_AA + j_E_AHV + j_E_AHE + j_E_G + j_E_M + j_E_H); % E, Reserve
