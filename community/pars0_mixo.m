...
global j_L_F Ctot Ntot j_V_Am j_L_FK K_C K_N K_NV K_D rho_A rho_H ...
  k_A k_H z_C z_CH z_N y_DV k_M h n_NV Lh;
...
%% extinction L(i) = L(i - 1) * e^(-1/Lh)
Lh = 20;         % m, vertical light extinction 

%% initial state (at time 0)
V0 = 0.01*Ctot;
E0 = 0.01*Ctot;
istate = [(Ctot-E0-V0); (Ntot-n_NV*(E0+V0)); E0; V0];

%% vertical mixing
upmix = 0.005*ones(4,1); % 1/d, upward transport rates
