function X = findstatec3_mixo (X_t)
  %% X = findstatec3_mixo (X_t)
  %% routine called from gstate3_mixo
  %% Differential equations for closed 3-reserve mixotroph system
  %% assuming C limitation, obtaining V and N from mass balance
...
k_E k_M kap_EC kap_EN h n_NV n_NE n_NEN
  ...
  C=X_t(1); DV=X_t(2); DE=X_t(3); E=X_t(4); EC=X_t(5); EN=X_t(6);
  V = Ctot - C - DV - DE - E - EC;
  N = Ntot - n_NV*DV - n_NE*DE - n_NV*V - n_NE*E - n_NEN*EN;
