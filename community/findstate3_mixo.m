function X = findstate3_mixo (X_t)
  %% X = findstate3_mixo (X_t)
...
k_E k_M kap_EC kap_EN h n_NV n_NE

  %% unpack state vector for easy reference
  DV=X_t(1); DE=X_t(2); V=X_t(3); E=X_t(4); EC=X_t(5); EN=X_t(6);
  m_E = E/V; m_EC = EC/V; m_EN = EN/V;
  C = Ctot - DV - DE - V - E - EC;
  N = Ntot - n_NV*DV - n_NE*DE - n_NV*V - n_NE*E - EN;
