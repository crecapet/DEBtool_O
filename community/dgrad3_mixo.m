function dX = dgrad3_mixo (X_t, t)
  %% dX = dgrad3_mixo (X_t, t)
  ...
  dX(1:nX) = dstate3(X_t(1:nX),t) - ...  %% local change
  ...
  for i = 2: (nL-1)
    ...
    dX((i-1)*nX + (1:nX)) = dstate3(X_t((i-1)*nX + (1:nX)),t) - ...
  ...
  %% bottum layer
  j_L_F = j_L_F/ e^(1/Lh);               %% light correction
  dX((nL-1)*nX + (1:nX)) = dstate3(X_t((nL-1)*nX + (1:nX)),t) - ...
