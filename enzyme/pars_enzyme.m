...
b_A = .1; % 1/(M.h) spec binding rate of substrate A
b_B = .1; % 1/(M.h) spec binding rate of substrate B
k_A = .1; % 1/h     turnover rate of enzyme-substr A complex
k_B = .2; % 1/h     turnover rate of enzyme-substr B complex
k_C = .4; % 1/h     turnover rate of enzyme-product C complex
J_Cm = 1; % M/h     max production rate
