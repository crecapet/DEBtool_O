...
%%
function [par_elt, chem_out, stat_html] = pet_html_content(par, chem, stat, txt_stat, T_ref) 
% created 2009/07/11 by Dina Lika, modified by Bas Kooijman 2014/06/03
% modified by starrlight augustine 2014/12/03 
...
% prepares the input for print_my_pet_html. 
%
% Input:
%
