function [q, info] = nmsurv2(func, p, t, y, Z)
  ...
  %% created: 2001/09/13 by Bas Kooijman; updated 2005/02/18
  %% calculates maximum likelihood estimates using Nelder Mead's simplex method
  %%    similar to scsurv2, but slower and a larger bassin of attraction
  ...
  n = size(index, 2); % n is number of parameters that must be iterated
  if (n == 0)
