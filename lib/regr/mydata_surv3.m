...
% set path to debtool/lib and debtool/tox
...
p_ga = gasurv3('fomort2',par,t,x,y,Z)  % par estimate using genetic algorithm
%% nm-algorithm: faster but less robust (and more local)
p_nm = nmsurv3('fomort2',p_ga,t,x,y,Z) % par estimate using nead-melder
%% scoring method: very fast but also very senbsitive for initial conditions
p_sc = scsurv3('fomort2',p_nm,t,x,y,Z) % par estimate using scoring method
