...
global par_iso_21 % for transfer to diso_21 and fniso_21
par_iso_21 = [p; m_E1b; m_E2b];
...
[M_E0 fn info] = fsolve(@fniso_21, [M_E10; M_E20], optimset('TolFun', 1e-6));

[F L_b a_b] = fniso_21(M_E0);
M_E10 = M_E0(1); M_E20 = M_E0(2);

%% subfunction fniso_21

function [F L_b a_b] = fniso_21(M_E0)
% for use by fsolve in iso_21: F = 0 if M_E0 are such that m_Eb are specified values

global par_iso_21
p = par_iso_21; m_E1b = p(end - 1); m_E2b = p(end);
...
LEa = lsode(@diso_21, [L_0; m_E10; m_E20; a_0], [E_H0; E_Hb]);
