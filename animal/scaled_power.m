function pACSJGRD = scaled_power(L, f, p, lb, lp)
  ...
  %% p: 9-vector with parameters (see maturity)
  %% lb: scalar with scaled length at birth for F; if not exsistent: NaN
  %% lp: scalar with scaled length at puberty for F; if not exsistent: NaN  
