...
% see ssd_iso for mean age, length, squared length, cubed length
% see f_ris0 for f at which r = 0

global tp tm hWG3 rho rhoB lp hW sG rho0 g lT vHp k f hG
...
if i == 100
    info = 0;
    fprintf('sgr_iso warning: no convergence for r in 100 steps\n')
else
    info = 1;
