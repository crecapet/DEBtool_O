function pACSJGRD = scaled_power_metam(L, f, p, lb, lj, lp)
  %% pACSJGRD = scaled_power_metam(L, f, p, lb, lj, lp)
  ...
  %% p: 10-vector with parameters (see maturity_metam)
  ...
  H = maturity_metam (L, f, p);  % scaled maturities E_H/ {p_Am}
  uH = H *  g^2 * kM^3/ v^2;
