function par = get_pars_9(data)
% [p_Am v kap p_M E_G E_Hb E_Hj E_Hp h_a] = get_pars_9 (d_V, a_b, a_p, a_m, W_b, W_j, W_p, W_m, R_m)
% from zero-variate data to DEB parameters 
% assumptions:
%   abundant food (f=1)
...
%
% data: 9-vector with zero-variate data, see below
% par:  9-vector with parameters
...
E_G = 2.6151E4 * d_V;          % J/cm^3, [E_G] costs for structure
...
[L HE] = ode45(@dget_HE, [1e-8; L_b; L_j; L_p], [0; E_0], [], L_b, L_j, L_m, s_M, E_m, v, p_M, E_G, kap, k_J);
