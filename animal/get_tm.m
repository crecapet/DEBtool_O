function [t_m S_b S_p info] = get_tm(p, F, l_b, l_p)
  %% [t_m S_b S_p info] = get_tm(p, F, l_b, l_p)
  %% created 2009/02/21 by Bas Kooijman; modified 2009/09/29
  %% calculates mean life span at constant f 
  ...
  x = lsode('dget_tm_egg', x0, [1e-6; l_b]);
