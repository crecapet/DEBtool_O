function dvars = dtraject(vars)
% called from traject and used in ode-solver
% specifies derivatives of state variables
% f equals 0 or 1

global vH_max vHb vHp g kapR1 kapG lT k k1 ha sG sH uE0 f
...
R = ((g + lT + l) * e * l^2/ (e + g) - k * vHp) * kapR1/ uE0; % reprod rate
dN = R * (vH >= vHp); % change in cum number of eggs
