function [par U] = get_pars_h(p, w, par0)
  ...
  %% Bas Kooijman, 2007/08/13
  %% several food levels, data on growth only; like get_pars_i, but
  %%   with stage transitions not at fixed amounts of structure
  ...
  %% iget_pars_h is inverse to get_pars_h
