...
JEAm = 1.5;  % 1: mmol/d/mm^2, {J_EAm}, spec max assim rate
...
JEM = 0.005;% 6: mmol/mm^3, [\dot{J}_EM], vol-spec som maint cost
...
yVE_D = 0.1; % 15: mol/mol, yield of structure on reserve in som maint
...
yOE_G = 10e-6; % 19: mol/mol, yield of otolith on reserve in growth
...
%%      X E V   E
odds = [1.1 1.1 1.1 1.1;  % C select for 13C in anabolic flux
	1   1   1   1;    % H
	1   1   1   1;    % O
	1   1   1   1];   % N
