function [par, U, Ep] = get_pars_s(p, w, par0)
  ...
  %% Bas Kooijman, 2006/12/15, modified 2007/03/23
  %% like get_pars_t (multiple food levels) get_pars_r (single level), but
  %%   without stage transitions at fixed amounts of structure
