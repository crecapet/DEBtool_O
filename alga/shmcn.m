function shmcn(j)
  %% shmcn(j); j is optional scalar with plot number
  %% created: 2007/01/19 by Bas Kooijman, modified 2009/02/20
  %% this function only sets parameters and plots; mcn does the computation
  %%
  ...
  tmrj = mcn(t,p,tLCN,mcn0); % get time trajectories %%%%%%%%%%%%%%%%%%%%%%%
