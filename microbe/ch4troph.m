...
%% created at 2001/10/04 by Bas Kooijman, modified 2009/02/20
...
KN = 0.01;  % mM, saturation constant for N
jEAm = 1.2; % mol/(h.mol), max spec assim rate (of E)
yEXA = .1; % mol/mol, yield of E on X (anabolic part of assim)
%% if yEXA = 1, C is not an anabolic substrate (type I anabolism)
...
ACX = yEXA - 1; ANX = - nNE*yEXA; AHX = 2 - ANX*3/2 - nHE*yEXA/2;
AOX = -AHX/2 - nOE*yEXA/2 - ACX;  % assimilation
...
Y = [-1, 1,   2,   -2,  0,   0,    0; ... % AC: assimilation (catabolic part)
     -1, ACX, AHX, AOX, ANX, yEXA, 0; ... % AA: assimilation (anabolic part)
