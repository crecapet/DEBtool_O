...
global T T_1 Tpars TC ...
    n_O n_M n w_O d_O m_Em mu_T mu_O mu_M eta_O ...
    jT_X_Am j_E_M j_E_J K y_E_X y_X_E y_V_E y_E_V kap ...
    m_Em g kT_M kT_J kT_E hT_a l_d f ...
    h h_X h_V h_P h_m r_m X_r zeta eta_O
...
n_O = [1.00, 1.00, 1.00, 1.00;  % C/C, equals 1 by definition
       ...
       0.50, 0.50, 0.50, 1.00;  % O/C
       0.20, 0.15, 0.20, 0.00]; % N/C
%% minerals
...
%% feeding parameters
j_X_Am = 0.2;    % mol/mol.d, max mass-spec uptake of substrate
K = 0.00001;       % M, half-saturation concentration

%% yield coefficients
y_E_X = 0.75;   % mol/mol, from food to reserve
y_X_E = 1/y_E_X;
y_V_E = 0.75;   % mol/mol, from reserve to structure
y_E_V = 1/y_V_E;
