function dX = dstate5 (X_t, t)
  ...
  a1 = max(1e-10,b2_S*S2s); a2 = max(1e-10,b2_P*P1s); % just for j2_Es
  ...
  j2_Ps = y2_PS*j2_Ss + y2_PP*j21_Ps + y2_PM*k2_M + ...
      y2_PG*max(1e-4,rs); % spec production
  ...
  j1_Ps = y1_PS*j1_S + y1_PP*j12_P + y1_PM*k1_M + ...
      y1_PG*max(1e-4,r1); % spec production
