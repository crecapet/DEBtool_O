...
%% this is the initial rate, from which a branch up and down starts
h1_V = h; h2_V = h; h1_S = h; h2_S = h; h1_P = h; h2_P = h;
%% hazard rates equal to throughput rate; chemostat conditions
...
b1_Ps = 1; b1_sP = 1; % product 1 transport to internal <-> mantle
b2_Ps = 1; b2_sP = 1; % product 2 transport to internal <-> mantle

%% attention! Double definition for y_ES and y_EP
%% y_es = y_Et/y_St; y_ep = y_Et/y_Pt
y1_es = y1_Et/y1_St; y2_es = y2_Et/y2_St;
y1_ep = y1_Et/y1_Pt; y2_ep = y2_Et/y2_Pt;
...
istate7 = [S1_r S2_r 0.011 0.012 0.013 0.014 .1 1.1 1];
